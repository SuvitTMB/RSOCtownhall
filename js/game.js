    ...
    snapshot.forEach(doc=> {
      ...
      if(doc.data().giftcode=="gift-99") {
        ...
        if(doc.data().StatusSend==1) {
          str += '<div class="boxtext" style="margin-top:30px; color:#000;">ยินดีด้วยคุณได้รับรางวัล<br><b>'+ doc.data().giftname +'</b></div>';
          ...
          str += '<div class="boxtext" style="margin-top:30px; color:#000;">ยินดีด้วยคุณได้รับรางวัล<br><b>'+ doc.data().giftname +'</b><br><br>คุณได้รับรางวัลเรียบร้อยแล้ว<br>'+ doc.data().SendGift +'</div>';
...
function GetRewards() {
  ...
  str += '<div style="margin:20px auto;"><img src="./img/'+ ShowGift +'.png" style="width:220px;"/></div>';
